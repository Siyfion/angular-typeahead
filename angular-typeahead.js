  ...
  .directive('sfTypeahead', function () {
      return {
          ...
          link: function (scope, element, attrs, ngModel) {
              ...
              // Watch the options and dataset objects for changes.
              scope.$watchCollection('[options, datasets]', function () {

                  // If the dataset has been set we move forward.
                  if (scope.datasets !== undefined) {
